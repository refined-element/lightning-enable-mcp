...
An open-source MCP (Model Context Protocol) server that enables AI agents to make Lightning Network payments and participate in agent-to-agent commerce. 26 tools total: 18 work out of the box (free, just a wallet), plus 2 producer tools and 6 Agent Service Agreement (ASA) tools for discovering, requesting, settling, and attesting services between agents on Nostr. Those 8 producer + ASA tools require an [Agentic Commerce subscription](https://lightningenable.com).
...
- [Full Docs](https://docs.lightningenable.com/products/l402-microtransactions/mcp-complete-guide) — Complete guide with all 26 tools
